    ...
    <layout>
        <info-block :title="infoBlocks.datenschutz.title" text=""
            ...
            <p>Personenbezogene Daten (nachfolgend zumeist nur „Daten“ genannt) werden von uns nur im Rahmen der
                ...
                Internetauftritts, inklusive seiner Inhalte und der dort angebotenen Leistungen, verarbeitet. Gemäß Art.
                4 Ziffer 1. der Verordnung (EU) 2016/679, also der Datenschutz-Grundverordnung (nachfolgend nur „DSGVO“
                genannt), gilt als „Verarbeitung“ jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführter
                ...
                verarbeiten. Unsere Datenschutzerklärung ist wie folgt gegliedert: </p>

            <ol class="list-decimal pt-5 px-5 text-lg">
                <li><a href="#part1">Informationen über uns als Verantwortliche</a></li>
                <li><a href="#part2">Rechte der Nutzer und Betroffenen</a></li>
                <li><a href="#part3">Informationen zur Datenverarbeitung</a></li>
            </ol>
            <section id="part1" class="pt-5">
                <p class="text-2xl pt-1 font-bold">I. Informationen über uns als Verantwortliche</p>
                <p>
                    <b>Freunde und Förderer des Gymnasiums Mellendorf e.V. </b><br/>
                    Fritz-Sennheiser-Platz 2<br/>
                    30900 Wedemark <br/>
                    <b>Telefon</b> +49 (0)5130/4542<br/>
                    <b>E-Mail:</b> info@ffgm.de<br/>
                </p>
            </section>
            <section id="part2" class="pt-5">
                <p class="text-2xl pt-1 font-bold">II. Rechte der Nutzer und Betroffenen</p>
                ...
                <ul class="list-disc py-1 px-5">
                    ...
                    <li>auf Berichtigung oder Vervollständigung unrichtiger bzw. unvollständiger Daten (vgl. auch Art.
                        16 DSGVO);
                    </li>
                    <li>auf unverzügliche Löschung der sie betreffenden Daten (vgl. auch Art. 17 DSGVO), oder,
                ...
                <p class="py-1">Darüber hinaus ist der Anbieter dazu verpflichtet, alle Empfänger, denen gegenüber Daten
                    durch den
                    ...
                    Auskunft über diese Empfänger.</p>
                <p class="font-semibold"> Ebenfalls haben die Nutzer und Betroffenen nach Art. 21 DSGVO das Recht auf
                    Widerspruch gegen
                    die künftige Verarbeitung der sie betreffenden Daten, sofern die Daten durch den Anbieter nach
                    Maßgabe von Art. 6 Abs. 1 lit. f) DSGVO verarbeitet werden. Insbesondere ist ein Widerspruch gegen
                    die Datenverarbeitung zum Zwecke der Direktwerbung statthaft.</p>
            </section>
            <section id="part3" class="pt-5">
                <p class="text-2xl pt-1 font-bold">III. Informationen zur Datenverarbeitung</p>
                ...
                <p class="text-xl pt-1 font-semibold">Serverdaten</p>
                ...
                <p>Diese so erhobenen Daten werden vorübergehend gespeichert, dies jedoch nicht gemeinsam mit anderen
                    Daten von Ihnen.</p>
                ...
                <p class="text-xl pt-2 font-bold">Cookies</p>
                <p class="text-lg pt-1 font-semibold">a) Sitzungs-Cookies/Session-Cookies</p>
                <p>Wir verwenden mit unserem Internetauftritt sog. Cookies. Cookies sind kleine Textdateien oder andere
                    ...
                    verarbeitet.</p>
                <p>Durch diese Verarbeitung wird unser Internetauftritt benutzerfreundlicher, effektiver und sicherer,
                    da die Verarbeitung bspw. die Wiedergabe unseres Internetauftritts in unterschiedlichen Sprachen
                ...
                <p class="text-lg pt-1 font-semibold">b) Drittanbieter-Cookies</p>
                ...
                <p class="text-lg pt-1 font-semibold">c) Beseitigungsmöglichkeit</p>
                <p>Sie können die Installation der Cookies durch eine Einstellung Ihres Internet-Browsers verhindern
                    oder einschränken. Ebenfalls können Sie bereits gespeicherte Cookies jederzeit löschen. Die hierfür
                    erforderlichen Schritte und Maßnahmen hängen jedoch von Ihrem konkret genutzten Internet-Browser ab.
                    Bei Fragen benutzen Sie daher bitte die Hilfefunktion oder Dokumentation Ihres Internet-Browsers
                    ...
                    Maßnahmen hängen von Ihrem konkret genutzten Flash-Player ab. Bei Fragen benutzen Sie daher bitte
                    ebenso die Hilfefunktion oder Dokumentation Ihres Flash-Players oder wenden sich an den Hersteller
                    bzw. Benutzer-Support.</p>
                ...
                <p class="text-xl pt-2 font-bold">Kundenkonto / Registrierungsfunktion</p>
                <p>Falls Sie über unseren Internetauftritt ein Kundenkonto bei uns anlegen, werden wir die von Ihnen bei
                    der Registrierung eingegebenen Daten (also bspw. Ihren Namen, Ihre Anschrift oder Ihre
                    E-Mail-Adresse) ausschließlich für vorvertragliche Leistungen, für die Vertragserfüllung oder zum
                    Zwecke der Kundenpflege (bspw. um Ihnen eine Übersicht über Ihre bisherigen Bestellungen bei uns zur
                    Verfügung zu stellen oder um Ihnen die sog. Merkzettelfunktion anbieten zu können) erheben und
                    speichern. Gleichzeitig speichern wir dann die IP-Adresse und das Datum Ihrer Registrierung nebst
                    Uhrzeit. Eine Weitergabe dieser Daten an Dritte erfolgt natürlich nicht.</p>
                <p>Im Rahmen des weiteren Anmeldevorgangs wird Ihre Einwilligung in diese Verarbeitung eingeholt und auf
                    diese Datenschutzerklärung verwiesen. Die dabei von uns erhobenen Daten werden ausschließlich für
                    die Zurverfügungstellung des Kundenkontos verwendet.&nbsp;</p>
                <p>Soweit Sie in diese Verarbeitung einwilligen, ist Art. 6 Abs. 1 lit. a) DSGVO Rechtsgrundlage für die
                    Verarbeitung.</p>
                <p>Sofern die Eröffnung des Kundenkontos zusätzlich auch vorvertraglichen Maßnahmen oder der
                    Vertragserfüllung dient, so ist Rechtsgrundlage für diese Verarbeitung auch noch Art. 6 Abs. 1 lit.
                    b) DSGVO.</p>
                <p>Die uns erteilte Einwilligung in die Eröffnung und den Unterhalt des Kundenkontos können Sie gemäß
                    Art. 7 Abs. 3 DSGVO jederzeit mit Wirkung für die Zukunft widerrufen. Hierzu müssen Sie uns
                    lediglich über Ihren Widerruf in Kenntnis setzen.</p>
                <p>Die insoweit erhobenen Daten werden gelöscht, sobald die Verarbeitung nicht mehr erforderlich ist.
                    Hierbei müssen wir aber steuer- und handelsrechtliche Aufbewahrungsfristen beachten.</p>

                <p class="text-xl pt-2 font-bold">Google-Maps</p>
                <p>In unserem Internetauftritt setzen wir Google Maps zur Darstellung unseres Standorts sowie zur
                ...
                <p>Rechtsgrundlage ist Art. 6 Abs. 1 lit. f) DSGVO. Unser berechtigtes Interesse liegt in der
                    Optimierung der Funktionalität unseres Internetauftritts.</p>
                <p>Durch die so hergestellte Verbindung zu Google kann Google ermitteln, von welcher Website Ihre
                    Anfrage gesendet worden ist und an welche IP-Adresse die Anfahrtsbeschreibung zu übermitteln
                    ist.</p>
                <p>Sofern Sie mit dieser Verarbeitung nicht einverstanden sind, haben Sie die Möglichkeit, die
